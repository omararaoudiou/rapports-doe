...
function PMTable({ plan, pmData, onChange }) {
  ...
  var COLS = [
    {k:'g4',       hdr:'4G (RSRP/RSRQ/Band)'},
    {k:'g5',       hdr:'5G (RSRP/RSRQ/Band)'},
    {k:'speedtest',hdr:'Speedtest DL/UL Mb'},
    {k:'operateur',hdr:'Operateur'},
  ];
